...
(function()
{
    ...
    function ParameterObject(div)
    {
        ...
        var type = Types.primitives[typeName].loadTypeFromDOM(div, div.find(".parameter-initial-value-container"), 'parameter');
    ...
    function EffectObject(div)
    {
        ...
        return {
            ...
            value: Parameters.container.byId[idRef].type.getFromDOM(div.find(".parameter-effect-value-container"))
        };
    }
